...
call <sid>hi('EndOfBuffer', s:cdGreen, s:cdBack, 'bold', {})
call <sid>hi('ErrorMsg', s:cdRed, s:cdBack, 'none', {})
call <sid>hi('VertSplit', s:cdGreen, s:cdNone, 'none', {})
...
call <sid>hi('CursorLineNr', s:cdGreen, s:cdBack, 'bold', {})
...
call <sid>hi('StatusLine', s:cdGreen, s:cdGreen, 'none', {})
call <sid>hi('StatusLineNC', s:cdGreen, s:cdGreen, 'none', {})
call <sid>hi('StatusLineTerm', s:cdGreen, s:cdGreen, 'none', {})
call <sid>hi('StatusLineTermNC', s:cdGreen, s:cdGreen, 'none', {})
